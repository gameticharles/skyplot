/// A class to define the position and size for the satellite ID text.
///
/// This class works similarly to the `Positioned` widget in Flutter but is
/// tailored for specifying the position of the satellite ID text within the SkyPlot widget.
/// It allows for the specification of left, top, right, bottom, width, and height constraints.
///
/// The `SatelliteIDTextPosition` can be used to place the satellite ID text at a specific
...
class SatelliteIDTextPosition {
  ...
  /// Constructs a [SatelliteIDTextPosition] with optional positional constraints.
  ///
